...
public class CategoryListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		item_count = (TextView) view.findViewById(R.id.txt_item_count);
		...
		Picasso.with(mContext)
				.load(resultp.get(CategoryActivity.TAG_CATEGORIES_LOGO)) // Photo URL
				.placeholder(R.drawable.image_bg) // This image will be displayed while photo URL is loading
				.error(R.drawable.image_bg) // if error shows up during downloading
